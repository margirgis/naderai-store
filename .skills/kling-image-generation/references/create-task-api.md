...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-dpgpkghtekg1-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dpgpkghtekg1-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
