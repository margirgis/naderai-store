...
|-------|-------|
| Method | `POST` |
| URL | `https://app-dpgpkghtekg1-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dpgpkghtekg1-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
