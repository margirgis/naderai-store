...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-dpgpkghtekg1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dpgpkghtekg1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
