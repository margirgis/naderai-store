...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-dpgpkghtekg1-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
| Query Task (Single) Endpoint | `GET https://app-dpgpkghtekg1-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
| Query Task (List) Endpoint | `GET https://app-dpgpkghtekg1-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
