...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-dpgpkghtekg1-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dpgpkghtekg1-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand",
    {
      method: "POST",
      headers: {
