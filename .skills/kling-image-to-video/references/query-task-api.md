...
| Property | Value |
|----------|-------|
| **Endpoint** | `GET https://app-dpgpkghtekg1-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/{id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dpgpkghtekg1-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
