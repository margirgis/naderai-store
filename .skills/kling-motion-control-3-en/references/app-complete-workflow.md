...
const CREATE_ENDPOINT =
  "https://app-dpgpkghtekg1-api-m9xKdopkqvMa.gateway.appmedo.com/motion-control/kling-3.0";
...
const QUERY_ENDPOINT = "https://app-dpgpkghtekg1-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks";
