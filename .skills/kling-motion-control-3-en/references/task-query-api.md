...
```http
GET https://app-dpgpkghtekg1-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?task_ids=TASK_ID
GET https://app-dpgpkghtekg1-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?external_task_ids=EXTERNAL_ID
