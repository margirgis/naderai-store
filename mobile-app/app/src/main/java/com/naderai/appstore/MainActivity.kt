...
import com.naderai.appstore.databinding.ActivityMainBinding
import com.naderai.appstore.sms.SmsReaderService
import com.naderai.appstore.sms.WebAppInterface
...
class MainActivity : AppCompatActivity() {
    ...
    private fun injectAppInfo(wv: WebView) {
        val deviceId = com.naderai.appstore.sms.DeviceInfo.getDeviceId(this)
